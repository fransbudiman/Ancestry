...
# highld.txt should be in $PWD/Configuration
...
REF_1KGENOMES=${CONFIG}/Reference_1KGenomes
...

{
    ...
    # Will concatenate "_1KGenomes" to our sample name to ensure it will not share same name with any of our population reference data.
    awk '{$2 = $2 "_1KGenomes"; print}' ${TEMPDIR}/${SAMPLE}_original.fam > ${TEMPDIR}/temp.fam
    mv ${TEMPDIR}/temp.fam ${TEMPDIR}/${SAMPLE}_original.fam

    # Set rsID to custom format (if allele is longer than 1000 base it will be subtituted with "."
